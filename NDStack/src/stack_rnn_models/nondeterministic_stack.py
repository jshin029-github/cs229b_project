...
class NondeterministicStackRNN(StackRNNBase):
    ...
    def initial_stack(self, input_tensor, batch_size, reading_size, sequence_length,
    ...
    def get_new_viterbi_stack(self, input_tensor, batch_size, sequence_length, semiring, block_size):
